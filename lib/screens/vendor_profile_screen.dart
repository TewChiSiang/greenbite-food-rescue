...
class _VendorProfileScreenState extends State<VendorProfileScreen> {
  ...
  Future<void> _changeProfilePhoto() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Store logo updated!'),
  ...
  void _deleteAccount() {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'Are you sure you want to permanently delete your business account? All your active listings will be lost.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(dialogContext),
  ...
  void _showStoreSettingsDialog(String currentBizName, String currentAddress) {
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(backgroundColor: Colors.deepOrange),
            onPressed: () async {
              if (bizNameController.text.trim().isEmpty) return;
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          String bizName = userData['businessName'] ?? 'Vendor Store';
          String initial = bizName.isNotEmpty ? bizName[0].toUpperCase() : 'V';
          String email = userData['email'] ?? currentUser!.email ?? '';
          String ssm = userData['ssmNumber'] ?? 'N/A';
          String address = userData['businessAddress'] ?? '';
          String status = userData['accountStatus'] ?? 'Pending';
          String? profileImageUrl = userData['profileImageUrl'];

          double averageRating = (userData['averageRating'] ?? 0).toDouble();
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        onTap: () => _showStoreSettingsDialog(bizName, address),
                      ),
                      const Divider(),
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const VendorReviewsScreen(),
                            ),
                          );
                        },
                      ),
